...
function BannerTopProduct(props) {
    return <>
        <div className="banner_top-product-mobile">
            ...
            <h4 className="banner_top-product-mobile-subtitle">One of the main features of the iPhone 14 was supposed to be
                    the
        ...
        <div className="banner_top-product-desktop">
            ...
            <div className="banner_top-product-info">
                <h1 className="banner_top-product-title">
                    Apple Iphone 14
                </h1>
                <h4 className="banner_top-product-subtitle">One of the main features of the iPhone 14 was supposed to be
                    the
                    absence of bangs, or reduction of them. In version 13...</h4>
                <Button
