    ...
    return (
        ...
        <div className="card-product">
            ...
            <div className="card-product__info">
                ...
                <p className="card-product__info__title">
                    {title}
                </p>
                ...
                <div className="card-product__info__price-container">
                    <span className="card-product__info__price-container__price">
                        ₴ {discountPrice}
                    </span>
                    <span className="card-product__info__price-container__discount">
                        ₴ {price}
                    </span>
                </div>
            </div>
...
ProductCard.defaultProps = {
    imageURL: "https://static.vecteezy.com/system/resources/previews/005/337/799/non_2x/icon-image-not-found-free-vector.jpg",
};
