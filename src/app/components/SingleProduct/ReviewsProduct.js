    ...
    return (
        <div className="tab-product-review">
            <div className="tab-product-review__card-list">
                ...
                <Pagination activePage={page} setActivePage={onPageChange} items={totalReviews}
                ...
                >
                    ...
                    <button type="submit" disabled={submitting || rating < 1} className="primary-btn">
                        <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 8.5L5.28571 13.25L16 1.375" stroke="white" strokeLinecap="round"
